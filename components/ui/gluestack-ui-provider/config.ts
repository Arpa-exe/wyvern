...
export const config = {
  light: vars({
    "--color-primary-0": "#FFB865",
    "--color-primary-50": "#FFB865",
    "--color-primary-100": "#FFB865",
    "--color-primary-200": "#FFB865",
    "--color-primary-300": "#FFB865",
    "--color-primary-400": "#FFB865",
    "--color-primary-500": "#FFB865",
    "--color-primary-600": "#FFB865",
    "--color-primary-700": "#FFB865",
    "--color-primary-800": "#FFB865",
    "--color-primary-900": "#FFB865",
    "--color-primary-950": "#FFB865",

    /* Secondary  */
    "--color-secondary-0": "#A50C25",
    "--color-secondary-50": "#A50C25",
    "--color-secondary-100": "#A50C25",
    "--color-secondary-200": "#A50C25",
    "--color-secondary-300": "#A50C25",
    "--color-secondary-400": "#A50C25",
    "--color-secondary-500": "#A50C25",
    "--color-secondary-600": "#A50C25",
    "--color-secondary-700": "#A50C25",
    "--color-secondary-800": "#A50C25",
    "--color-secondary-900": "#A50C25",
    "--color-secondary-950": "#A50C25",

    /* Tertiary */
    "--color-tertiary-0": "#250205",
    "--color-tertiary-50": "#250205",
    "--color-tertiary-100": "#250205",
    "--color-tertiary-200": "#250205",
    "--color-tertiary-300": "#250205",
    "--color-tertiary-400": "#250205",
    "--color-tertiary-500": "#250205",
    "--color-tertiary-600": "#250205",
    "--color-tertiary-700": "#250205",
    "--color-tertiary-800": "#250205",
    "--color-tertiary-900": "#250205",
    "--color-tertiary-950": "#250205",
    ...
    /* Background */
    "--color-background-0": "#A50C25",
    "--color-background-50": "#A50C25",
    "--color-background-100": "#A50C25",
    "--color-background-200": "#A50C25",
    "--color-background-300": "#A50C25",
    "--color-background-400": "#A50C25",
    "--color-background-500": "#A50C25",
    "--color-background-600": "#A50C25",
    "--color-background-700": "#A50C25",
    "--color-background-800": "#A50C25",
    "--color-background-900": "#A50C25",
    "--color-background-950": "#A50C25",
